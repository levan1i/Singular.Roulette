...
namespace Singular.Roulette.Repository.Migrations
{
    ...
    [Migration("20220903115908_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Singular.Roulette.Domain.Models.UserAccount", b =>
                {
            ...
            modelBuilder.Entity("Singular.Roulette.Domain.Models.UserAccount", b =>
                {
                    b.HasOne("Singular.Roulette.Domain.Models.Account", null)
                        .WithOne()
                        .HasForeignKey("Singular.Roulette.Domain.Models.UserAccount", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
